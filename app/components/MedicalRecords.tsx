      ...
      <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
        <div className="bg-white rounded-lg shadow-xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div>
                ...
                <select
                  ...
                  onChange={(e) => setFormData({...formData, visitType: e.target.value as 'routine' | 'emergency' | 'follow_up' | 'admission' | 'discharge'})}
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">Medications (Name|Dosage|Frequency|Duration)</label>
              <textarea
                value={formData.medications}
                onChange={(e) => setFormData({...formData, medications: e.target.value})}
                rows={4}
                placeholder="Paracetamol|500mg|3 times|7 days&#10;Vitamin D|1000IU|Once daily|30 days"
                className="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
              />
            </div>
